...
from modules.sub_modules import get_all_subdomains
...
class OSINTModule(RedTeamModule):
    def __init__(self, target, options=None):
        ...
        load_and_bind_methods(self, {
            ...
            'get_all_subdomains' : 'modules.sub_modules.subdomain_lookup.get_all_subdomains'
        })
    ...
    def subdomain_lookup_wrapper(self):
        ...
        subdomains = get_all_subdomains(self)
